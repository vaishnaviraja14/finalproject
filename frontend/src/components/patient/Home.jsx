          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="w-[270px] h-[300px] border border-gray-200 rounded-lg bg-[#D4A373] shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">KMCH</h5>
                                <span className="text-sm text-black">Multispeciality Hospital</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/Hospital1" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">View details</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">Ganga</h5>
                                <span className="text-sm text-black">Ortho Specialist</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/Hospital1" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">View details</a>
                                </div>
                            </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">Genisis</h5>
                                <span className="text-sm text-black">Gynac</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/Hospital1" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">View details</a>
                                </div>
                            </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">NRP</h5>
                    ...
                    <div className='flex gap-3'>
                        <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">Kidney Centre</h5>
                                <span className="text-sm text-black">Kidney Specialist</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/Hospital1" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">View details</a>
                                </div>
                            </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">GKNM</h5>
                                <span className="text-sm text-black">Heart Specialaist</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/Hospital1" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">View details</a>
                                </div>
                            </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">Cutis</h5>
                                <span className="text-sm text-black">Skin clinic</span>
                                <div className="flex mt-4 md:mt-6">
                                <a href="/Hospital1" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700 ms-3">View details</a>
                                </div>
                            </div>
                        ...
                        <div className="w-[270px] h-[300px] bg-[#D4A373] border border-gray-200 rounded-lg shadow flex justify-center">
                            <div className="flex flex-col items-center justify-center ">
                                ...
                                <h5 className="mb-1 text-xl font-medium text-black">KG</h5>
                                <span className="text-sm text-black">Dialysis centre</span>
                                <div className="flex mt-4 md:mt-6">
